...
import sys
import pathlib
from sdap_ingest_manager.history_manager import FileIngestionHistory
...
class DatasetIngestionHistoryFileTestCase(unittest.TestCase):
    ...
    def test_purge(self):
        self.ingestion_history = FileIngestionHistory("/Users/loubrieu/PycharmProjects/sdap_ingest_manager/venv/.sdap_ingest_manager/tmp/history/",
