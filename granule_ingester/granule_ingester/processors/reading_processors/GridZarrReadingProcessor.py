...
from granule_ingester.processors.reading_processors.ZarrReadingProcessor import ZarrReadingProcessor


class GridZarrReadingProcessor(ZarrReadingProcessor):
    ...
    # TODO generate after L2 v L4 meeting
